...
<spring:url value="/carrusel" var="urlBanners" />
...
<body>
	...
	<div class="caja-contenedor-admin">
			...
			<h3>Listado de imagenes para el CARRUSEL del menú Principal</h3>

			<c:if test="${msg !=null }">
				<div class='alert alert-success' role='alert'>${msg}</div>
			</c:if>

			<a href="${urlBanners}/create" class="btn btn-success" role="button"
				...
				<table class="table table-hover table-striped table-bordered">
					...
					<c:forEach items="${banners}" var="banner">
						<tr>
							...
							<td><a href="${urlBanners}/edit/${banner.id}"
								class="btn btn-success btn-sm" role="button" title="Edit"><span
									class="glyphicon glyphicon-pencil"></span></a> <a
								href="${urlBanners}/delete/${banner.id}"
