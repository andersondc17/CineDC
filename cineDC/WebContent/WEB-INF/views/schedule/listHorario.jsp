...
<html lang="en">
	...
	<spring:url value="/schedule" var="urlHorarios" />
...
<body>
	...
	<div class="caja-contenedor-admin">
		...
		<nav aria-label="">
		  <ul class="pager">
		    <li><a href="${urlHorarios}/indexPagination?page=${horarios.number - 1 }">Anterior</a></li>
		    <li><a href="${urlHorarios}/indexPagination?page=${horarios.number + 1 }">Siguiente</a></li>
		  </ul>
		</nav>
